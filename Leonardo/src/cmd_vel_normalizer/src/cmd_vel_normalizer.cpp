...
#define V_MAX 0.362f
#define W_MAX (2.0f * V_MAX / WHEEL_SEPARATION)

class CmdVelNormalizer : public rclcpp::Node {
public:
  CmdVelNormalizer() : Node("cmd_vel_normalizer") {
    pub_ = this->create_publisher<geometry_msgs::msg::Twist>("cmd_vel_nav2_norm", 10);
